export const STRINGS_ES = {
  ...
  syncModal: {
    ...
    clippingsProgressMessage:
      'Analizando tus archivos My Clippings.txt para notas y destacados...',
  ...
  templateEditorModal: {
    ...
    message:
      '¿Estás seguro de que quieres cerrar el editor de plantillas sin guardar? Tus cambios se perderán.',
  ...
  settings: {
    ...
    templates: {
      title: 'Plantillas',
      description:
        'Gestiona y edita plantillas para nombres de archivo y contenido de notas destacadas.',
      button: 'Gestionar',
    },
    highlightsFolder: {
    ...
    highlightsBaseFile: {
      ...
      description:
        'Crea un archivo base personalizable de Obsidian en la ubicación de la carpeta de notas para mostrar tus notas y metadatos de Kindle.',
      button: 'Crear archivo base',
    },
    downloadBookMetadata: {
      title: 'Descargar metadatos del libro',
      description:
        'Descarga metadatos adicionales del libro desde Amazon.com. Desactiva para acelerar el proceso de sincronización.',
    },
    useObsidianFileProperties: {
      title: 'Usar propiedades de archivo de Obsidian',
      description:
        'Almacenar metadatos del libro en las propiedades de archivo de Obsidian (front matter).',
    },
    downloadHighResImages: {
      title: 'Descargar imágenes de libro de alta resolución',
      description:
        'Descarga imágenes de portada de libros de alta resolución cuando estén disponibles.',
    },
    syncOnStartup: {
      title: 'Sincronizar al iniciar',
      description:
        'Sincroniza automáticamente las nuevas notas de Kindle cuando se inicia Obsidian (solo sincronización de Amazon)',
    },
  ...
  templates: {
    ...
    fileContent: {
      ...
      description:
        'Plantilla para un archivo de notas destacadas. Esto puede incluir YAML front matter.',
    },
    highlight: {
      pane: 'Nota destacada',
